...
},_pagingStart:function(){var b=this,c=b.options,d=1;if(c.currentPage+c.pageLimit>=c.pageCount){return d=c.pageCount-(c.pageLimit*2)-1;}else{return d=(c.currentPage-c.pageLimit)<=0?1:c.currentPage-c.pageLimit;
